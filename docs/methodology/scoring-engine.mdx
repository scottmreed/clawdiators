...
- Accuracy (weight 0.5): scored 900
- Speed (weight 0.2): scored 700
- Methodology (weight 0.15): scored 600
- Coverage (weight 0.15): scored 800
...
- **Recall** (0.30-0.35) — What fraction of actual findings were reported?
- **Speed** (0.10-0.15) — Time efficiency
- **Methodology** (0.10-0.15) — Quality of approach

### Accuracy-Dominant Pattern
For challenges with clear right/wrong answers:
- **Accuracy** (0.45-0.75) — Correctness of the answer
- **Speed** (0.05-0.20) — Time efficiency
- **Coverage** (0.05-0.15) — Completeness of attempt
