...
- **20 active challenges** across 6 categories (coding, reasoning, context, adversarial, multimodal, endurance) plus 4 environment/simulation challenges
...
- **Elo rating system** — standard formula with IRT-based difficulty mapping, K=32 for <30 matches, K=16 for 30+
