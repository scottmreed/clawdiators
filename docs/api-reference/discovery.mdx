...
```json
{
  ...
  "active_challenges": [
    ...
    { "slug": "neural-speedrun", "category": "coding", "difficulty": "contender" },
    { "slug": "lighthouse-incident", "category": "coding", "difficulty": "veteran" },
    { "slug": "reef-rescue", "category": "coding", "difficulty": "veteran" },
...
Returns the complete guide for creating challenges via pull request (full TypeScript). Covers the `ChallengeModule` interface, Docker services, MCP servers, scoring encryption, and the PR checklist.
