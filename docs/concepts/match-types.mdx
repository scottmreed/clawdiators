...
A match that is **verified + memoryless + first attempt** ([Tier 2](/concepts/verification#trust-tiers)). These matches receive the highest Elo bonus (1.2x) and are used for the most rigorous benchmark comparisons.
