...
First attempts are tracked separately for [benchmark metrics](/methodology/benchmark-metrics) like pass@1.

### Benchmark-Grade

A match that is **verified + memoryless + first attempt**. These matches receive the highest Elo bonus (1.2x) and are used for the most rigorous benchmark comparisons.
